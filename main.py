...
parser.add_argument('--detection_model', default='weights/craft_mlt_25k.pth', type=str, help='pretrained model')
...
parser.add_argument('--width_height_ratio', default=0.55, type=float, help='to check if rotated')
parser.add_argument('--rotate', default=True, help='to apply if rotated')
...
parser.add_argument('--imgH', default=32, type=int, help='the height of the input image')
parser.add_argument('--imgW', default=100, type=int, help='the width of the input image')
...
parser.add_argument('--unknown', default=False, help='whether to use unknown in prediction')
...
parser.add_argument('--FeatureExtraction', default='VGG', type=str, help='FeatureExtraction stage. VGG|RCNN|ResNet')
...
parser.add_argument('--num_fiducial', default=20, type=int, help='number of fiducial points of TPS-STN')
parser.add_argument('--input_channel', default=1, type=int, help='the number of input channel of Feature extractor')
parser.add_argument('--output_channel', default=512, type=int,
